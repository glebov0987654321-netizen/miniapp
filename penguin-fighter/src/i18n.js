...
(function (global) {
  ...
  const STRINGS = {
    ru: {
      ...
      hero_h3_name: 'Неко-чан',
      hero_h3_desc: 'Быстрый бросок пера',
      hero_h4_name: 'Пёс-босс',
      hero_h4_desc: 'Мощный лазерный залп',
    ...
    en: {
      ...
      hero_h3_name: 'Neko-chan',
      hero_h3_desc: 'Fast feather throw',
      hero_h4_name: 'Big Doggo',
      hero_h4_desc: 'Powerful laser blast',
